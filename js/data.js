...
const _dungeonList = [
    ...
    ["Petalburg Woods","Rusturf Tunnel","Granite Cave","Fiery Path","Meteor Falls","Mt. Chimney Crater","Jagged Pass","New Mauville","Weather Institute","Mt. Pyre","Magma Hideout","Aqua Hideout","Shoal Cave","Cave of Origin","Seafloor Cavern","Sky Pillar","Sealed Chamber","Victory Road Hoenn"],
    ["Oreburgh Gate","Valley Windworks","Eterna Forest","Old Chateau","Team Galactic Eterna Building","Wayward Cave","Mt. Coronet South","Solaceon Ruins","Iron Island","Lake Valor","Lake Verity","Mt. Coronet North","Lake Acuity","Team Galactic HQ","Spear Pillar","Distortion World","Victory Road Sinnoh","Sendoff Spring","Hall of Origin","Fullmoon Island","Newmoon Island","Flower Paradise","Snowpoint Temple","Stark Mountain"],
